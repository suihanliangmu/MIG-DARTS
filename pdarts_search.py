...
parser.add_argument('--note', type=str, default='pdarts', help='note for this run')

# parser.add_argument('--dropout_rate', action='append', default=[], help='dropout rate of skip connect')
parser.add_argument('--dropout_rate', action='append', default=['0.1', '0.4', '0.7'],
                    help='dropout rate of skip connect')
